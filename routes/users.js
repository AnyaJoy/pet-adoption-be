...
router.post("/signup", validateBody(schemas.signupSchema), doesUserExistSignup, doPasswordsMatch, encryptPassword, usersController.signupController);
...
.put(validateBody(schemas.updateUserSchema), checkToken, encryptPassword,usersController.editUserController)
